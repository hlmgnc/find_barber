...
const booking2 = new Booking(hilmi, cem, apptDate)
bookings.push(booking2)

const booking3 = new Booking(paloma, mihri, apptDate)
bookings.push(booking3)

const booking4 = new Booking(alina, furkan, apptDate)
bookings.push(booking4)

const booking5 = new Booking(jing, furkan, apptDate)
bookings.push(booking5)

const booking6 = new Booking(gaby, cem, apptDate)
bookings.push(booking6)

const booking7 = new Booking(gaby, mihri, apptDate)
